...
/**
 * Immutable implementation of {@link GetApplicationRequest}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutableGetApplicationRequest.builder()}.
 */
@Generated(from = "GetApplicationRequest", generator = "Immutables")
@SuppressWarnings({"all"})
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
public final class ImmutableGetApplicationRequest extends GetApplicationRequest {
  private final String applicationId;

  private ImmutableGetApplicationRequest(ImmutableGetApplicationRequest.Builder builder) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableGetApplicationRequest} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(@Nullable Object another) {
    if (this == another) return true;
    return another instanceof ImmutableGetApplicationRequest
        && equalTo((ImmutableGetApplicationRequest) another);
  }

  private boolean equalTo(ImmutableGetApplicationRequest another) {
  ...
  /**
   * Creates a builder for {@link ImmutableGetApplicationRequest ImmutableGetApplicationRequest}.
   * <pre>
   * ImmutableGetApplicationRequest.builder()
   *    .applicationId(String) // required {@link GetApplicationRequest#getApplicationId() applicationId}
   *    .build();
   * </pre>
   * @return A new ImmutableGetApplicationRequest builder
   */
  public static ImmutableGetApplicationRequest.Builder builder() {
    return new ImmutableGetApplicationRequest.Builder();
  }

  /**
   * Builds instances of type {@link ImmutableGetApplicationRequest ImmutableGetApplicationRequest}.
  ...
  public static final class Builder {
    ...
    /**
     * Fill a builder with attribute values from the provided {@code chattyer.nlp.wit.client.apps.GetApplicationRequest} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    ...
    /**
     * Builds a new {@link ImmutableGetApplicationRequest ImmutableGetApplicationRequest}.
     * @return An immutable instance of GetApplicationRequest
     * @throws java.lang.IllegalStateException if any required attributes are missing
     */
    public ImmutableGetApplicationRequest build() {
      if (initBits != 0) {
        throw new IllegalStateException(formatRequiredAttributesMessage());
      }
      return new ImmutableGetApplicationRequest(this);
    }
